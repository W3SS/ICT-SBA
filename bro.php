...
<html>
	<head>
		<title>SVI System - Browser</title>
	...
	<body>
		<div id="blockuser">
					...
					<div id="flexcontainer">
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(0)" onmouseover="mouseOver(0)" src="img/bro/chrome.jpg" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(1)" onmouseover="mouseOver(1)" src="img/bro/fox.jpg" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest ">
								<img onclick="UI_onClick(2)" onmouseover="mouseOver(2)" src="img/bro/ie.jpg" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(3)" onmouseover="mouseOver(3)" src="img/bro/opera.jpg" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(4)" onmouseover="mouseOver(4)" src="img/bro/safari.jpg" width="100%" height="28%" />
							</div>
						</div>
					</div>
				</div>
			...
			<div class="Detail">
				<span id="bn" class="textoverflow"><strong>按下圖示投票自己最喜歡的軟件</strong></span>
			</div>
