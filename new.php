					...
					<div id="flexcontainer">
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(0)" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()" onmouseover="mouseOver(0)" src="img/new/south.gif" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(1)" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()" onmouseover="mouseOver(1)" src="img/new/Google.jpg" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(2)" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()" onmouseover="mouseOver(2)" src="img/new/fox.png" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(3)" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()" onmouseover="mouseOver(3)" src="img/new/bbc.png" width="100%" height="28%" />
							</div>
						</div>
						<div id="flexitem" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()">
							<div class="bordertest">
								<img onclick="UI_onClick(4)" onmouseenter="playc_s()" onclick="playc_s()" onmouseleave="playc_s()" onmouseover="mouseOver(4)" src="img/new/apple.png" width="100%" height="28%" />
							</div>
						</div>
					</div>
				</div>
